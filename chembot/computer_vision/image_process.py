...
def predict(device=3, skip=3):
    command = f"fswebcam -d /dev/video{device} -r 1920x1080 -S {skip} --no-banner /home/robot/code/yolov5/images/image1.jpg"
    ...
    results = model("/home/robot/code/yolov5/images/image1.jpg")
    res = []
